...
This repository contains a `revocation gRPC server app` written in `Go`. It provides a simple custom revocation function for platform service in `AccelByte Gaming Services`.
